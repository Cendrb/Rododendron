...
package com.cendrb.rododendron.client.model.bitch;

import net.minecraft.client.model.ModelCow;
import net.minecraft.client.model.ModelRenderer;
import net.minecraft.entity.Entity;

public class ModelYvonne extends ModelCow
{
  //fields
    ModelRenderer head;
    ModelRenderer body;
  ...
  public ModelYvonne()
  {
    ...
    textureHeight = 32;
      ...
      head.mirror = true;
      setRotation(head, 1.412787F, 1.950741F, 2.862753F);
      body = new ModelRenderer(this, 18, -3);
      body.addBox(-6F, -10F, -7F, 12, 25, 10);
